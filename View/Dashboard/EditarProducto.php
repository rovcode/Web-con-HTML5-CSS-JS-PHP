            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Editar tipo personal 
                      ...
                      foreach($list as $value){
                        ...
                        $estado=$value['ESTADO'];
                        $imagen=$value['IMAGEN'];
                        $idcategoria=$value['CATEGORIA_ID'];
                      }
                      ?></h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="ListaProductos.php">Productos</a></li>
                            ...
                            <div class="col-12 col-sm-4 col-lg-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nombre" id="nombre"
                                        placeholder="Nombres" value="<?php echo $nombre?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4 col-lg-4 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-sm-4 col-lg-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="calificacion" id="calificacion"
                                        placeholder="5" value="<?php echo $calificacion?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4 col-lg-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="precio" id="precio"
                                        placeholder="5.0" value="<?php echo $precio?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4 col-lg-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="descuento" id="descuento"
                                        placeholder="" value="<?php echo $descuento?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4 col-lg-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="estado" id="estado"
                                        placeholder="02/02/1995" value="<?php echo $estado?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4 col-lg-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="correo" id="imagen"
                                        placeholder="usuario@magentastyle.com" value="<?php echo $imagen?>">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4 col-lg-4 col-xs-12">
                                <div class="form-group">
...
function ActualizarProducto() {
    let option = "Actualizar_Producto"
