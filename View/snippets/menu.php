...
?>
<div class="container">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #FFFFFF !important">
        <a class="navbar-brand" href="<?php $Config->getRoute("index.php");?>"><img width="50" height="50"
                src="Public/asset/img/ico.ico" alt=""> Magenta
            Style</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto navbar-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php $Config->getRoute("sobremagenta.php");?>">Nosotros</a>
                </li>
                <li class="nav-item">
